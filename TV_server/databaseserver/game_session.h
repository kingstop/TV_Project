...
public:
	...
	void parseMsgSaveRecordGS2DB(google::protobuf::Message* p, pb_flag_type flag);
	void parseMsgReqCharacterIDGS2DB(google::protobuf::Message* p, pb_flag_type flag);
	void parseMsgReqCharacterDataGS2DB(google::protobuf::Message* p, pb_flag_type flag);
