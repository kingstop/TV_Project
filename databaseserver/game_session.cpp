...
{
	message::MsgReqCharacterDataGS2DB* msg =(message::MsgReqCharacterDataGS2DB*)p;
	gDBQuestMgr.QueryCharacterInfo(msg->character_id(), flag, m_game_id);
}
...
void GameSession::parseMsgReqCharacterIDGS2DB(google::protobuf::Message* p, pb_flag_type flag)
{
	message::MsgReqCharacterIDGS2DB* msg = (message::MsgReqCharacterIDGS2DB*)p;
	gDBQuestMgr.QueryCharacterID(msg->account(), flag, m_game_id);
}
