...
public:
	...
	~DBQuestManager();
public:
	void QueryCharacterID(account_type a, tran_id_type t, u16 gs);
	void QueryCharacterInfo(u64 id, tran_id_type t, u16 gs);
...
private:
	void onSaveToClose();
protected:
	void dbDoQueryAccCharacterRelationship(const SDBResult* r, const void* d, bool s);
	void dbDoQueryKeyWordCharacter(const SDBResult* r, const void* d, bool s);
	void dbDoQueryCharacterInfo(const SDBResult* r, const void* d, bool s);
	void dbDoQueryCharacterCollectionMovie(const SDBResult* r, const void* d, bool s);
	//void dbDoQueryHeroInfo(const SDBResult* r, const void* d, bool s);
	//void dbDoQueryHeroDeals(const SDBResult* r, const void* d, bool s);
	//void dbDoQueryHeroDealInfos(const SDBResult* r, const void* d, bool s);
